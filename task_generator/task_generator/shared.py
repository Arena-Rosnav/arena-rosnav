...
class DynamicObstacle(DynamicObstacleProps):
    ...
    def parse(obj: dict, model: ModelWrapper) -> "DynamicObstacle":
        ...
        _type = behavior_dict.get(
            'type', DEFAULT_AGENT_CONFIG['agent1']['behavior']['type'])
        # DEFAULT_AGENT_CONFIG['agent1']['behavior']['state'])
        _state = behavior_dict.get('state', 0)
        _conf = behavior_dict.get(
            'configuration',
            DEFAULT_AGENT_CONFIG['agent1']['behavior']['configuration'])
        _duration = behavior_dict.get(
            'duration', DEFAULT_AGENT_CONFIG['agent1']['behavior']['duration'])
        _once = behavior_dict.get(
            'once', DEFAULT_AGENT_CONFIG['agent1']['behavior']['once'])
        _vel = behavior_dict.get(
            'vel', DEFAULT_AGENT_CONFIG['agent1']['behavior']['vel'])
        _dist = behavior_dict.get(
            'dist', DEFAULT_AGENT_CONFIG['agent1']['behavior']['dist'])
        _social_force = behavior_dict.get(
            'social_force_factor',
            DEFAULT_AGENT_CONFIG['agent1']['behavior']['social_force_factor'])
        _goal_force = behavior_dict.get(
            'goal_force_factor',
            DEFAULT_AGENT_CONFIG['agent1']['behavior']['goal_force_factor'])
        _obstacle_force = behavior_dict.get(
            'obstacle_force_factor',
            DEFAULT_AGENT_CONFIG['agent1']['behavior']['obstacle_force_factor'])
        _other_force = behavior_dict.get(
            'other_force_factor',
            DEFAULT_AGENT_CONFIG['agent1']['behavior']['other_force_factor'])
        ...
        _group_id = obj.get(
            'group_id',
            DEFAULT_AGENT_CONFIG['agent1']['group_id'])
        _yaw = obj.get('yaw', 0.0)
        _velocity = None
        _desired_velocity = obj.get(
            'max_vel', DEFAULT_AGENT_CONFIG['agent1']['max_vel'])
        _radius = obj.get('radius', DEFAULT_AGENT_CONFIG['agent1']['radius'])
        _linear_vel = 0.0
        _angular_vel = 0.0
        _goals = []
        _cyclic_goals = obj.get('cyclic_goals',
                                DEFAULT_AGENT_CONFIG['agent1']['cyclic_goals'])
        _goal_radius = obj.get('goal_radius',
                               DEFAULT_AGENT_CONFIG['agent1']['goal_radius'])
        _closest_obs = []
